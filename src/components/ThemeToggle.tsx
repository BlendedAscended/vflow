...
const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      aria-pressed={isDark}
      onClick={toggleTheme}
      className="hidden lg:flex items-center justify-center w-10 h-10 rounded-full border border-black/10 bg-white/70 hover:bg-white transition-colors shadow fixed right-6 top-24 z-50"
    >
      {isDark ? (
