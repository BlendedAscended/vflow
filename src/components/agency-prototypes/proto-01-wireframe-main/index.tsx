...
import VerbaFlowHologramFloor from './VerbaFloor';

/* ─── Tweak defaults (tweaks-panel.jsx out of scope) ─── */
const TWEAKS = {
  world: 'hologram' as string,
  timeOfDay: 'morning' as string,
  occupancy: 'crowded' as string,
};
...
const Cap = ({
  ...
  <div
    className={`${styles['sk-cap']} ${dark ? styles.dark : ''} ${green ? styles.green : ''}`}
    style={style}
  >
    {children}
  </div>
...
const Pawn = ({
  ...
  <div
    className={`${styles.pawn} ${dark ? styles.dark : ''} ${color ? styles[color] || color : ''}`}
    style={{ width: size, height: size }}
  >
    {status && (
      <span
        className={`${styles['status-dot']} ${status ? styles[status] || status : ''}`}
...
const Pill = ({
  ...
  <span className={`${styles['sk-pill']} ${variant ? styles[variant] || variant : ''}`} style={style}>
    {children}
  </span>
);
...
const PixScene = ({ type }: { type: string }) => {
...
const AnnoBar = ({
  ...
  <div className={`${styles['anno-bar']} ${dark ? styles.dark : ''}`}>
...
const HeroFloor = ({
  ...
  >
    ...
    >
      <div style={{ maxWidth: 680 }}>
        ...
        <p className={styles['hero-sub']} style={{ maxWidth: 480 }}>
          Watch your AI agents and supervisors work in real time. The floor is always live — drop in, click any
          room, book any slot.
        </p>
      </div>
    ...
    {/* HERO: full-width hologram floor plan */}
    <div className={styles['hero-floor-full']}>
      <VerbaFlowHologramFloor />
    </div>
    ...
    <div className={styles['team-services-row']}>
      <div className={styles['roster-panel']}>
        ...
        {(
          ...
          ] as { n: string; s: string; c: string; av: string }[]
        ).map((a) => (
    ...
    <div className={styles['stat-strip']}>
      <div className={`${styles['sk-box']} ${styles.dark}`} style={{ padding: 18 }}>
        ...
        <div
          style={{ fontFamily: 'Caveat', fontSize: 54, fontWeight: 700, lineHeight: 1, color: '#fff', marginTop: 4 }}
        >
          7
        </div>
    ...
    <div className={styles['section-inner']}>
      <div className={styles['sec-head']}>
        ...
        <div className={styles['sec-side']}>
          Two persistent cards that live just below the office. Public metrics on the left. The activity stream on
          the right.
        </div>
      </div>
        ...
        <div className={styles['sk-box']} style={{ padding: 22 }}>
          ...
          <div className={styles.g2} style={{ marginTop: 14 }}>
            <div
              ...
              style={{ padding: 14, background: 'rgba(165,214,167,0.18)', borderColor: 'var(--accent-strong)' }}
            >
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 11 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontFamily: 'DM Mono', fontSize: 10, color: 'var(--ink-3)', marginTop: 1 }}>
                    {it.t}
                  </div>
                </div>
              </div>
      ...
      <div className={styles.bento}>
        ...
        <div className={`${styles['b-card']} ${styles.tall} ${styles.green}`}>
          <div>
            ...
            >
              Deploy intelligent chatbots that qualify leads, answer FAQs, and book appointments — 24/7, without
              human intervention.
            </p>
          </div>
  ...
  <div id="agents" className={`${styles.section} ${styles.dark}`}>
    <div className={styles['section-inner']}>
      ...
      <div className={styles.g4} style={{ marginBottom: 24 }}>
        {(
          [
            { n: 'San', r: 'Supervisor (Human)', s: 'Live · in Command Center', c: 'green', online: 'live' },
            { n: 'Titan', r: 'Outreach AI', s: 'Running batch · 1.2k', c: 'note', online: 'live' },
            { n: 'Guardian', r: 'Reliability AI', s: 'Idle · last fix 12m ago', c: 'blue', online: 'off' },
            { n: 'Prometheus', r: 'Engine Room AI', s: 'Building Galaxy QA · busy', c: 'amber', online: 'busy' },
          ] as { n: string; r: string; s: string; c: string; online: string }[]
        ).map((a) => (
          ...
          >
            ...
            <div className={styles.g3} style={{ marginTop: 18, gap: 8 }}>
              ...
              >
                ...
                <div style={{ fontFamily: 'Kalam', fontSize: 10, color: 'rgba(255,255,255,0.5)' }}>
                  async, &lt; 4h
                </div>
              </div>
              <div
            ...
            <div style={{ marginTop: 18, paddingTop: 14, borderTop: '1px solid var(--dark-border)' }}>
              ...
              <div style={{ display: 'flex', gap: 6, marginTop: 8, flexWrap: 'wrap' }}>
                {['Today 14:00', 'Today 15:30', 'Tom 10:00', 'Tom 11:30', 'Tom 14:00'].map((s) => (
  ...
  <div id="how" className={`${styles.section} ${styles.paper}`}>
    <div className={styles['section-inner']}>
      <div className={styles['sec-head']}>
        ...
        <div className={styles['sec-side']}>
          Linked steps — dotted line connects them, like a floor-plan corridor.
        </div>
      </div>
      ...
      <div className={styles.steps}>
        {[
          ...
          <div key={s.n} className={styles.step}>
            ...
            <p style={{ fontFamily: 'Kalam', fontSize: 13, color: 'var(--ink-2)', marginTop: 8, lineHeight: 1.55 }}>
              {s.d}
            </p>
          </div>
        ))}
  ...
  <div id="pricing" className={`${styles.section} ${styles.cream}`}>
    <div className={styles['section-inner']}>
      <div className={styles['sec-head']}>
        ...
        <div className={styles['sec-side']}>
          Same names as your existing tiers. Featured tier scaled up + pinned ribbon.
        </div>
      </div>
      ...
      <div className={styles.g3} style={{ alignItems: 'stretch' }}>
        ...
        ].map((p: { n: string; p: string; d: string; f: string[]; featured?: boolean }) => (
          <div key={p.n} className={`${styles.pcard} ${p.featured ? styles.featured : ''}`}>
            ...
            >
              {p.f.map((item) => (
                <li
                  key={item}
                  style={{ fontFamily: 'Kalam', fontSize: 13, display: 'flex', gap: 8, alignItems: 'flex-start' }}
                >
...
const CTASection = () => (
  <div id="cta" className={styles.cta}>
    ...
    <div style={{ position: 'relative', zIndex: 2 }}>
      ...
      >
        Book a 15-minute discovery call. We&apos;ll show you your future agency floor — populated with agents
        already running for clients like you.
      </p>
...
export default function Proto01WireframeMain() {
  const { world, timeOfDay, occupancy } = TWEAKS;
    ...
    <>
      ...
      <div className={styles['ctx-bar']}>
        <div>
          ...
          <div className={styles.meta}>
            ...
            edge-to-edge dark (Huly-style). Sections below: Live Ops · Services · Agents · How it works · Pricing ·
            CTA. Includes profile-drawer + booking interaction sketch.
          </div>
        </div>
      ...
      <div className={styles.workspace}>
        ...
        <div className={styles.mock}>
          ...
          <HeroFloor world={world} timeOfDay={timeOfDay} occupancy={occupancy} />
          <AnnoBar
            dark
            num="01"
            items={[
