...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Absolutely! We provide 24/7 technical support, regular system maintenance, performance monitoring, security updates, and ongoing optimization to ensure your digital infrastructure runs smoothly and efficiently."
    }
  ];
        ...
        <div className="max-w-xl mx-auto  text-center space-y-6">
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-gray-700">
              ...
              >
                <span className="text-white text-xl font-medium pr-8">
                  {faq.question}
                </span>
                <svg
