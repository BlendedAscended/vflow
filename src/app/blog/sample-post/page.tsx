...
const sampleBlogPost = {
  ...
  excerpt: 'Explore how artificial intelligence is transforming modern business operations and what it means for your company\'s future success.',
  content: [
    {
      _type: 'block',
      style: 'h2',
    ...
    },
    {
      _type: 'block',
      style: 'normal',
      children: [{ text: 'Artificial Intelligence (AI) is no longer a futuristic concept—it\'s a present reality that\'s reshaping how businesses operate, compete, and grow. From automating routine tasks to providing deep insights from data, AI is becoming an essential tool for modern enterprises.' }]
    },
    {
      _type: 'block',
      style: 'h3',
